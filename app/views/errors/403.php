...
<div class="container error-page">
    ...
    <p class="error-page__desc">No tienes permisos para ver este recurso.</p>
    <?php if (!empty($message)): ?>
        <p class="text-muted small mb-4">Detalle: <?= htmlspecialchars($message) ?></p>
    <?php endif; ?>
    <div class="error-page__actions">
        <a class="btn btn-outline-primary" href="<?= Config::getBaseUrl() ?>">
            <i class="fas fa-home me-1"></i> Ir al inicio
        </a>
        <a class="btn btn-outline-secondary" href="<?= Config::getBaseUrl() ?>?route=contact">
